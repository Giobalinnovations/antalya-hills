            ...
            <div className="w-full lg:w-1/2 text-white space-y-8">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-lg md:text-xl">Gurugram</p>
                </div>
                <div className="flex items-center gap-3">
                  <PriceIcon className="w-6 h-6 flex-shrink-0" />
                  <p className="text-lg md:text-xl">
                    Starting from ₹2.19 Crores
                  </p>
                </div>
              </motion.div>
              ...
              >
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-lg">
                      <span className="text-primary">51 acre</span> Gated
                      Society
                    </p>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-lg">
                      Private{' '}
                      <span className="text-primary">Terrace Space</span>
                    </p>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 rounded-full bg-primary" />
